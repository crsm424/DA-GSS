...
if not os.path.isdir('/media/base/DG-Net-master/outputs/CUHK'):
...
parser.add_argument('--input_folder', type=str, default="/media/base/DG-Net-master/visual_data/inputs_many_train", help="input image path")

parser.add_argument('--config', type=str, default='/media/base/DG-Net-master/outputs/%s/config.yaml'%name, help="net configuration")
parser.add_argument('--checkpoint_gen', type=str, default="/media/base/DG-Net-master/outputs/%s/checkpoints/gen_00100000.pt"%name, help="checkpoint of autoencoders")
parser.add_argument('--checkpoint_id', type=str, default="/media/base/DG-Net-master/outputs/%s/checkpoints/id_00100000.pt"%name, help="checkpoint of autoencoders")
...
save_path = '/media/base/DG-Net-master/visual_data/rainbow_PRW'
