...
def evaluate(qf,ql,qc,gf,gl,gc):
    ...
    #junk_index = np.append(junk_index1) #.flatten())
    
    CMC_tmp = compute_mAP(index, qc, good_index,score)
    return CMC_tmp


def compute_mAP(index, qc, good_index,score):
    ap = 0
    ...
    #recall_rate =1.0
    #ap =  average_precision_score(a, score) * recall_rate
