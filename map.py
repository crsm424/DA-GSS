...
parser.add_argument('--test_dir', default='/media/base/img/0.4CUHK', type=str, help='./test_data')
parser.add_argument('--name', default='CUHK-50', type=str, help='save model path')
parser.add_argument('--batchsize', default=160, type=int, help='batchsize')
