...
parser.add_argument('--output_folder', type=str, default="./Market/search/off-gan_id1/", help="output image path")
parser.add_argument('--output_folder2', type=str, default="./Market/search/off-gan_bg1/", help="output image path")
parser.add_argument('--input_folder', type=str, default="./Market/search/train_all/", help="input image path")

parser.add_argument('--name', type=str, default="latest", help="model name")
...
os.system('cd ./TTUR; python fid.py ../Market/search/train_all --i ../Market/search/off-gan_id1 --gpu 0')
